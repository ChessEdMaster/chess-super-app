...
const Tabs = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { defaultValue?: string, value?: string, onValueChange?: (value: string) => void }>(
    ({ className, defaultValue, value, onValueChange, children, ...props }, ref) => {
        ...
        const finalOnValueChange = onValueChange || setInternalValue
        ...
        return (
            <button
                ...
                className={cn(
                    ...
                    isSelected && "bg-background text-foreground shadow-sm bg-neutral-800 text-white",
                    !isSelected && "text-neutral-400 hover:text-white",
                    className
                )}
                {...props}
            />
